...
3.x 阶段（v3.0.0–v3.6.0）为预发布演进，详细条目见下方历史段落。
...
本版本合并了 v2.110.0 ~ v2.140.0 的 31 次小版本增量，按主题归并如下。逐条原始记录见 `docs/archive/CHANGELOG_v2.md`。
...
> 完整逐条记录已归档至 `docs/archive/CHANGELOG_v2.md`，此处仅保留阶段摘要。
...
- 完整逐条变更记录（141 个历史小版本）：[CHANGELOG_v2.md](archive/CHANGELOG_v2.md)
